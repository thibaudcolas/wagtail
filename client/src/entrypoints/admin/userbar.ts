...
export class Userbar extends HTMLElement {
    ...
    */
    ...
    const resetItemsTabIndex = () => {
      listItems.forEach((listItem) => {
        ...
        (
          listItem.firstElementChild as HTMLAnchorElement | HTMLButtonElement
        ).tabIndex = -1;
      });
    };
  ...
  */
  ...
  async initialiseAxe() {
    ...
    if (!accessibilityTrigger) return;
