...
-   When you get to the copy page form, you can then choose another page as the parent page. Click the New parent page’s _Choose another_ button.

![Clicking the "choose another" button during the copy page form in order to change the parent of the copied page.](../_static/images/screen12.7_1_alias_choose_parent_page_button.png)
